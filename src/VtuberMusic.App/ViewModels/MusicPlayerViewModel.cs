...
public class MusicPlayerViewModel : AppViewModel {
    public Music PlayingMusic => MediaPlaybackService.NowPlaying;
    public MediaPlaybackState PlayerState => MediaPlaybackService.Statue;
    public TimeSpan PlayerPosition { get => MediaPlaybackService.Position; set => MediaPlaybackService.Position = value; }
    public TimeSpan PlayerDuration => MediaPlaybackService.Duration;
    ...
    public double Volume {
        ...
        set => MediaPlaybackService.Volume = value;
    }
