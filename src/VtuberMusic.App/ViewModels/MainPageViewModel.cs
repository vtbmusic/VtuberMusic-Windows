...
public class MainPageViewModel : AppViewModel {
    ...
    public ObservableCollection<NavigationViewItemBase> NavigationItems { get; set; } = new ObservableCollection<Microsoft.UI.Xaml.Controls.NavigationViewItemBase>
    {
    ...
    public ObservableCollection<NavigationViewItemBase> PaneFooterNavigationItems { get; set; } = new ObservableCollection<Microsoft.UI.Xaml.Controls.NavigationViewItemBase>
    {
    ...
    private static Microsoft.UI.Xaml.Controls.NavigationViewItem createNavgationItem(Type type, string title, IconElement icon, object args = null) => new() { Icon = icon, Content = title, Tag = new NavigationTag { Type = type, Args = args } };
}